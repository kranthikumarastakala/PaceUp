...
import { Activity, Home, User, PlusCircle, BarChart2, LogOut, Menu, X, Search, Target, Trophy, Settings, MessageCircle, Map, ClipboardList } from 'lucide-react'
...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed top-16 right-0 bottom-0 z-40 w-72 bg-white shadow-2xl border-l border-gray-100 flex flex-col md:hidden transition-transform duration-300 ease-in-out',
